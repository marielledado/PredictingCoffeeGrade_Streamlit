...
def main():
    ...
    st.sidebar.markdown("Single-origin coffee are considered 'specialty' grade if professional coffee tasters (aka [Q-graders](https://www.coffeeinstitute.org/our-work/a_common_language/what-is-a-q-grader/)) give it a score of 80 (out of 100) or higher. Specialty coffees scoring between 80-84.99 are considered *very good* coffees; coffee scoring 85 or more are considered *excellent* coffees.")
